  ...
  return (
    <div className="bg-background pt-32 pb-24">
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        ...
        >
          <h1 className="font-serif text-5xl md:text-6xl text-primary mb-6">The Story of Charm Antique</h1>
        ...
        >
          <div className="prose prose-lg prose-p:text-muted-foreground prose-headings:font-serif prose-headings:text-primary">
            ...
            <p>
              Charm Antique wasn't born out of a grand business plan. It began in 1998, quite by accident, in a damp garage filled to the brim with things I simply couldn't bear to leave behind at estate sales and auctions.
            </p>
            <p>
